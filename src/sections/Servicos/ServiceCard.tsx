  ...
  return (
    <article
      className="
        ...
        rounded-2xl border border-white/10 bg-[#0D1117] p-6
        transition-all duration-500
        hover:-translate-y-2 hover:border-blue-500/70
        hover:shadow-[0_20px_50px_rgba(37,99,235,0.18)]
        sm:w-72 sm:shrink-0 sm:p-7
      "
    >
      ...
      <div
        className="
          ...
          h-40 w-40 rounded-full bg-blue-600/10 blur-3xl
          transition-all duration-500
      ...
      <div className="relative z-10 flex h-full min-w-0 flex-col">
        <header>
          ...
          <h3 className="mt-3 break-words text-xl font-bold leading-tight text-white sm:text-2xl">
            {service.title}
          </h3>

          <p className="mt-4 break-words text-sm leading-6 text-gray-400 sm:text-base sm:leading-7">
            {service.description}
          </p>
        </header>
        ...
        <ul className="space-y-4">
          {service.includedServices.map((includedService) => (
            ...
            >
              ...
              <span className="min-w-0 break-words">{includedService}</span>
            </li>
          ))}
        </ul>
        ...
        <div className="mt-auto pt-8">
          <a
            ...
            className="
      group/button flex w-full items-center justify-center gap-3
      rounded-xl border border-blue-500/40
      bg-blue-500/10 px-5 py-3
